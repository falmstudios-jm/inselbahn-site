...
const galleryRow1 = [
  ...
  { src: "/images/extra-img_2207-large.jpeg", alt: "Inselbahn am Hafen" },
          ...
          <div className="grid md:grid-cols-2 gap-10 lg:gap-16 items-center">
            ...
            <div>
              ...
              <p className="text-dark/60 text-base md:text-lg leading-relaxed">
                ...
                Highlights bequem und entspannt - ohne anstrengende Wege,
                ohne etwas zu verpassen. Lehnen Sie sich zur&uuml;ck und genie&szlig;en Sie
