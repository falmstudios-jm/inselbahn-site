...
const timelineSteps = [
  {
    ...
    description:
      "Je nach Fähre erreichen Sie Helgoland zwischen 9:00 und 11:30 Uhr. Vom Anleger sind es nur wenige Minuten zu Fuß zum Franz-Schensky-Platz, dem Startpunkt der Inselbahn.",
  },
  {
    time: "11:00 - 12:30",
      ...
      <div className="px-5 md:px-10 lg:px-20 py-16 md:py-20">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-dark/60 text-base md:text-lg mb-8 max-w-2xl mx-auto">
            ...
            Platz. Abfahrt am Franz-Schensky-Platz, nur wenige Minuten von allen
