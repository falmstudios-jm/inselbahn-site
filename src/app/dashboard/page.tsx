...
export default function DeparturesPage() {
  ...
  // Undo cancellation
  const handleUncancelDeparture = async (departureId: string) => {
    try {
      await fetch(
        `/api/dashboard/cancel-departure?departure_id=${departureId}&booking_date=${selectedDate}`,
        { method: 'DELETE' }
      );
      loadDepartures();
    } catch { /* silent */ }
              ...
              >
                ...
                <div className="flex items-center justify-between mb-2">
                  <div className="flex items-center gap-2 flex-wrap">
                    ...
                    <span className={`text-lg font-bold ${dep.cancelled ? 'text-gray-400 line-through' : 'text-dark'}`}>
