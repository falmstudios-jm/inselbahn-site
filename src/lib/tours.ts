...
export const FALLBACK_TOURS: Tour[] = [
  {
    ...
    name: 'Unterland-Tour',
    description:
      'An Bord unserer Inselbahn gleiten Sie mit maximal 6 km/h durch das Unterland - vorbei an den legendären Hummerbuden mit ihren Galerien und Schmuckläden, dem historischen Binnenhafen (von den Helgoländern \u201eScheibenhafen\u201c genannt), dem Seenotrettungskreuzer Hermann Marwede und dem Alfred-Wegener-Institut für Meeresforschung. Ihr Guide erzählt vom \u201eBig Bang\u201c 1947, der Rückkehr der Insel 1952 und dem zollfreien Alltag auf Deutschlands einziger Hochseeinsel.',
    duration_minutes: 40,
    max_capacity: 42,
    price_adult: 11,
    price_child: 6,
    ...
    notes: 'inkl. kurzem Fotostopp im Nordostland mit Klippen-Blick',
  },
  {
    id: 'fallback-premium',
    slug: 'premium-tour',
